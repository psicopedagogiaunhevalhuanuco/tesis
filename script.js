...
async function generateMatrixWithGemini(topic) {
    ...
    Asegúrate de que exista una clara correspondencia entre los indicadores de las variables y los ítems del cuestionario. Considera que los indicadores son la base para la creación de los ítems y que cada ítem debe medir uno o más indicadores específicos. Garantiza que la matriz refleje esta relación de manera coherente y que el instrumento sea adecuado para medir las variables de interés.
