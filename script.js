...
async function generateMatrixWithGemini(topic) {
    ...
    Asegúrate de que exista una clara correspondencia entre los indicadores de las dimensiones de las variables y los ítems del cuestionario. Los indicadores son operativamente definidos como el conjunto de respuestas obtenidas de rangos específicos de ítems dentro del instrumento de medición (cuestionario, encuesta, test, etc.). Por ejemplo, el "indicador de la dimensión empatía" se define como las respuestas obtenidas de los ítems 1 al 7 del cuestionario aplicado. Garantiza que la matriz refleje esta relación de manera coherente y que el instrumento sea adecuado para medir las variables de interés y que haya sido aplicado en otro estudios de investigación con las mismas características de la población.
